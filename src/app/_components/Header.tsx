...
export default async function Header() {
  ...
  return (
    <header className="sticky z-[100] h-16 inset-x-0 top-0 w-full border-b border-gray-20 bg-white/75 backdrop-blur-lg transition-all">
      <MaxWidthWrapper>
        <div className="w-full h-full flex gap-2 items-center justify-between">
          <div>
            <Link href="/" className="text-2xl font-bold">{`Artist's Terminal`}</Link>
          </div>
